%This MATLAB program finds Average F-Measure for the feature set FS_i(2) with kNN classifier.
% 15 measurements have taken with this progam then averaged them manually to find average F-Measure
...
%SVMModels = fitcsvm(datatrain,classtrain,'KernelFunction','rbf','BoxConstraint',1);
knn=fitcknn(datatrain, classtrain,'NumNeighbors',3);
[label,score] = predict(knn,datatest);
